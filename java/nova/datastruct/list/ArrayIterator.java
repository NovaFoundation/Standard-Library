...
public class ArrayIterator extends NovaObject implements Iterator
{
	private NovaArray array;
	...
	public ArrayIterator(NovaArray array)
	{
		init(array);
	}
	...
	public void init(NovaArray array)
	{
		this.array = array;
		reset();
	}
