var DoubleArray = function () {
	...
	this.DoubleArray = function () {
		self.this();
	};
	
	this.DoubleArray = function (count) {
		self.this(count);
	};
	
	this.DoubleArray = function (data, count) {
	...
	this.reverse = function () {
		...
		var nova_local_0;
		var element;
		array = new DoubleArray(self.count);
	...
	this.accessor_iterator = function () {
		return new DoubleArrayIterator(self);
	};
