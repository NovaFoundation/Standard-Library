...
{
	nova_svg_Nova_SvgComponent_virtual_Nova_generateOutput((nova_svg_Nova_SvgComponent*)(this->nova_svg_Nova_Svg_Nova_root), exceptionData, nova_svg_Nova_Svg_Nova_file);
}
