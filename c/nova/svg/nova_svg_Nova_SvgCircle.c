...
nova_svg_Nova_SvgCircle* nova_svg_Nova_SvgCircle_Nova_construct(nova_svg_Nova_SvgCircle* this, nova_exception_Nova_ExceptionData* exceptionData, double x, double y, int r)
{
	...
	{
		nova_svg_Nova_SvgCircle_Nova_this(this, exceptionData, x, y, r);
	}
...
{
	this->nova_svg_Nova_SvgCircle_Nova_x = x;
	this->nova_svg_Nova_SvgCircle_Nova_y = y;
	this->nova_svg_Nova_SvgCircle_Nova_r = r;
}
