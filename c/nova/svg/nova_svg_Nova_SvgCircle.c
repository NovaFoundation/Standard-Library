...
nova_svg_SvgCircle_Extension_VTable nova_svg_SvgCircle_Extension_VTable_val =
{
	{
		0,
		0,
...
nova_svg_Nova_SvgCircle* nova_svg_Nova_SvgCircle_Nova_construct(nova_svg_Nova_SvgCircle* this, nova_exception_Nova_ExceptionData* exceptionData, double nova_svg_Nova_SvgCircle_Nova_x, double nova_svg_Nova_SvgCircle_Nova_y, int nova_svg_Nova_SvgCircle_Nova_r)
{
	...
	this->vtable = &nova_svg_SvgCircle_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_svg_Nova_SvgComponent_Nova_super((nova_svg_Nova_SvgComponent*)this, exceptionData);
	nova_svg_Nova_SvgCircle_Nova_super(this, exceptionData);
	
	{
		nova_svg_Nova_SvgCircle_Nova_this(this, exceptionData, nova_svg_Nova_SvgCircle_Nova_x, nova_svg_Nova_SvgCircle_Nova_y, nova_svg_Nova_SvgCircle_Nova_r);
	}
...
{
	nova_io_Nova_File_Nova_write(nova_svg_Nova_SvgCircle_Nova_file, exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("<circle cx=\"")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_x))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\" cy=\"")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_y))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\" r=\"")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_r))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\" stroke=\"false\" fill=\"black\"/>\n")))))))));
}
...
{
	return nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("[Circle at (")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_x))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_y))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(") with a radius of ")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_static_Nova_toString(0, exceptionData, (this->nova_svg_Nova_SvgCircle_Nova_r))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("]"))))))));
}
