...
nova_svg_SvgComponent_Extension_VTable nova_svg_SvgComponent_Extension_VTable_val =
{
	{
		0,
		0,
...
nova_svg_Nova_SvgComponent* nova_svg_Nova_SvgComponent_Nova_construct(nova_svg_Nova_SvgComponent* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_svg_SvgComponent_Extension_VTable_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_svg_Nova_SvgComponent_Nova_super(this, exceptionData);
	
	{
		nova_svg_Nova_SvgComponent_Nova_this(this, exceptionData);
	}
...
{
	this->vtable->nova_svg_Nova_SvgComponent_virtual_Nova_generateOutput((nova_svg_Nova_SvgComponent*)(this), exceptionData, nova_svg_Nova_SvgComponent_Nova_file);
}
