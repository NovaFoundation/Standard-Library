...
{
	nova_exception_Nova_Exception_0_Nova_this((nova_exception_Nova_Exception*)(this), exceptionData, nova_math_Nova_InvalidNumericStatementException_Nova_message);
}
