...
{
	nova_math_logic_Nova_LogicalStatement_Nova_this((nova_math_logic_Nova_LogicalStatement*)(this), exceptionData, nova_math_logic_Nova_Conclusion_Nova_statement);
}
