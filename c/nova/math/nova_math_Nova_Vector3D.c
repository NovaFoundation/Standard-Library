...
{
	nova_math_Nova_Vector3D_0_Nova_this(this, exceptionData, 0, 0, 0);
}
...
{
	this->nova_math_Nova_Vector3D_Nova_x = nova_math_Nova_Vector3D_Nova_x;
	this->nova_math_Nova_Vector3D_Nova_y = nova_math_Nova_Vector3D_Nova_y;
	this->nova_math_Nova_Vector3D_Nova_z = nova_math_Nova_Vector3D_Nova_z;
}
...
{
	return nova_math_Nova_Vector3D_1_Nova_construct(0, exceptionData, this->nova_math_Nova_Vector3D_Nova_y * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_z - this->nova_math_Nova_Vector3D_Nova_z * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_y, this->nova_math_Nova_Vector3D_Nova_z * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_x - this->nova_math_Nova_Vector3D_Nova_x * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_z, this->nova_math_Nova_Vector3D_Nova_x * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_y - this->nova_math_Nova_Vector3D_Nova_y * nova_math_Nova_Vector3D_Nova_other->nova_math_Nova_Vector3D_Nova_x);
}

nova_Nova_String* nova_math_Nova_Vector3D_Nova_toString(nova_math_Nova_Vector3D* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("<")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_math_Nova_Vector3D_Nova_x))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_math_Nova_Vector3D_Nova_y))), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_static_Nova_toString(0, exceptionData, (this->nova_math_Nova_Vector3D_Nova_z))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(">"))))))));
}

void nova_math_Nova_Vector3D_Nova_super(nova_math_Nova_Vector3D* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	this->nova_math_Nova_Vector3D_Nova_x = 0;
	this->nova_math_Nova_Vector3D_Nova_y = 0;
	this->nova_math_Nova_Vector3D_Nova_z = 0;
}
