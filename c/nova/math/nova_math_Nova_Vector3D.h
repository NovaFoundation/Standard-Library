...
struct nova_math_Vector3D_Extension_VTable
{
	...
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(nova_math_Nova_Vector3D*, nova_exception_Nova_ExceptionData*);
...
(
	...
	double nova_math_Nova_Vector3D_Nova_y;
