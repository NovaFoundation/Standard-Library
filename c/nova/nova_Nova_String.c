...
void nova_Nova_String_Nova_testLambda25(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* match, int _2, nova_datastruct_list_Nova_Array* _3, Context1* context);
void nova_Nova_String_Nova_testLambda26(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_regex_Nova_Match* match, int _2, nova_datastruct_list_Nova_Array* _3, Context2* context);
...
{
	return nova_Nova_String_Nova_compareTo(this, exceptionData, other) == 0;
}
...
nova_Nova_String* nova_Nova_String_1_Nova_replace(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* search, nova_Nova_String* replace)
{
	...
	l1_Nova_output = this;
	l1_Nova_index = (int)(0);
	while ((l1_Nova_index = nova_Nova_String_1_Nova_indexOf(l1_Nova_output, exceptionData, search, (intptr_t)nova_null, (intptr_t)nova_null, (intptr_t)nova_null)) >= 0)
	{
...
{
	return this->nova_Nova_String_Nova_count > 0 && nova_Nova_String_1_Nova_indexOf(this, exceptionData, search, (intptr_t)nova_null, (intptr_t)nova_null, (intptr_t)nova_null) == this->nova_Nova_String_Nova_count - search->nova_Nova_String_Nova_count - 1;
}
...
{
	int l1_Nova_nova_local_0 = 0;
	nova_regex_Nova_Match* l1_Nova_nova_local_1 = (nova_regex_Nova_Match*)nova_null;
	...
	return (int)((l1_Nova_nova_local_0 = (int)((l1_Nova_nova_local_1 = (nova_regex_Nova_Match*)(nova_datastruct_list_Nova_Array_virtual_Accessor_Nova_first((nova_datastruct_list_Nova_Array*)(nova_regex_Nova_Regex_0_static_Nova_getMatches(0, exceptionData, search, this)), exceptionData))) != (nova_regex_Nova_Match*)nova_null ? (l1_Nova_nova_local_1->nova_regex_Nova_Match_Nova_start) : 0)) != (int)nova_null ? l1_Nova_nova_local_0 : (int)0);
}

int nova_Nova_String_1_Nova_indexOf(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* search, int start, int direction, int defaultReturnValue)
{
	int l1_Nova_i = 0;
...
int nova_Nova_String_Nova_lastIndexOf(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* search, int start, int defaultReturnValue)
{
	...
	defaultReturnValue = (int)(defaultReturnValue == (intptr_t)nova_null ? -1 : defaultReturnValue);
	return nova_Nova_String_1_Nova_indexOf(this, exceptionData, search, start, -1, defaultReturnValue);
}
...
nova_Nova_String* nova_Nova_String_Nova_trim(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, int start, int end)
{
	...
	while (start < this->nova_Nova_String_Nova_count && nova_datastruct_list_Nova_CharArray_Nova_contains(nova_Nova_String_Nova_WHITESPACE, exceptionData, (char)(intptr_t)(nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, start++))));
	while (end >= 0 && nova_datastruct_list_Nova_CharArray_Nova_contains(nova_Nova_String_Nova_WHITESPACE, exceptionData, (char)(intptr_t)(nova_datastruct_list_Nova_CharArray_Nova_get((nova_datastruct_list_Nova_CharArray*)(this->nova_Nova_String_Nova_chars), exceptionData, end--))));
	return (nova_Nova_String*)(end == 0 ? nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")) : nova_Nova_String_Nova_substring(this, exceptionData, start - 1, end + 2));
}
...
nova_Nova_String* nova_Nova_String_Nova_getStringBetween(nova_Nova_String* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* before, nova_Nova_String* after, int start)
{
	...
	start = (int)(start == (intptr_t)nova_null ? 0 : start);
	l1_Nova_s = nova_Nova_String_1_Nova_indexOf(this, exceptionData, before, start, (intptr_t)nova_null, (intptr_t)nova_null);
	l1_Nova_e = nova_Nova_String_1_Nova_indexOf(this, exceptionData, after, l1_Nova_s + 1, (intptr_t)nova_null, (intptr_t)nova_null);
