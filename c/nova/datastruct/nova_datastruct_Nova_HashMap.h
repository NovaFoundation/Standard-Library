...
struct nova_datastruct_HashMap_Extension_VTable
{
	...
	nova_datastruct_Nova_Pair* (*nova_datastruct_list_Nova_List_virtual_Nova_skip)(nova_datastruct_Nova_HashMap*, nova_exception_Nova_ExceptionData*, int);
	nova_datastruct_Nova_Pair* (*nova_datastruct_list_Nova_List_virtual_Nova_take)(nova_datastruct_Nova_HashMap*, nova_exception_Nova_ExceptionData*, int);
	...
	nova_datastruct_Nova_HashMap* (*nova_datastruct_Nova_HashMap_virtual_Nova_put)(nova_datastruct_Nova_HashMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*, nova_Nova_Object*);
};
