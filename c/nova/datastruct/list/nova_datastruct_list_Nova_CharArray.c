...
long_long nova_datastruct_list_Nova_CharArray_Nova_testLambda7(nova_datastruct_list_Nova_CharArray* this, nova_exception_Nova_ExceptionData* exceptionData, long_long v, char c, int i, nova_datastruct_list_Nova_CharArray* a, Context1* context);
char nova_datastruct_list_Nova_CharArray_Nova_testLambda37(nova_datastruct_list_Nova_CharArray* this, nova_exception_Nova_ExceptionData* exceptionData, char _1, Context2* context);
