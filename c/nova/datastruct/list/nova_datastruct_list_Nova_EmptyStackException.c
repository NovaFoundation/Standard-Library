...
{
	nova_datastruct_list_Nova_NoSuchElementException_0_Nova_this((nova_datastruct_list_Nova_NoSuchElementException*)(this), exceptionData, nova_datastruct_list_Nova_EmptyStackException_Nova_message);
}
