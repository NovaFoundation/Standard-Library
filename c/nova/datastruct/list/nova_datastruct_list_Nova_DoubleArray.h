...
struct nova_datastruct_list_DoubleArray_Extension_VTable
{
	...
	nova_datastruct_list_Nova_DoubleArray* (*nova_datastruct_list_Nova_List_virtual_Nova_toArray)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*);
	nova_datastruct_list_Nova_DoubleArray* (*nova_datastruct_list_Nova_Array_virtual_Nova_clone)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*);
	...
	nova_datastruct_list_Nova_DoubleArray* (*nova_datastruct_list_Nova_List_virtual_Nova_take)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*, int);
	nova_datastruct_list_Nova_DoubleArray* (*nova_datastruct_list_Nova_List_virtual_Nova_skip)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*, int);
	nova_datastruct_list_Nova_DoubleArray* (*nova_datastruct_list_Nova_List_virtual_Nova_reverse)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*);
	...
	nova_Nova_String* (*nova_datastruct_list_Nova_List_virtual_Nova_join)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
};
