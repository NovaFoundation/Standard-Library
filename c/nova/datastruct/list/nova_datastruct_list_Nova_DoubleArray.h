...
struct nova_datastruct_list_DoubleArray_Extension_VTable
{
	...
	nova_datastruct_list_Nova_DoubleArrayIterator* (*nova_datastruct_list_Nova_Iterable_virtual_Accessor_Nova_iterator)(nova_datastruct_list_Nova_DoubleArray*, nova_exception_Nova_ExceptionData*);
