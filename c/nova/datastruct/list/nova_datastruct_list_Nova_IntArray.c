...
{
	{
		...
		(void(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure3_Nova_func nova_datastruct_list_Nova_List_Nova_func, void* nova_datastruct_list_Nova_List_ref_Nova_func, void* func_context))nova_datastruct_list_Nova_IntArray_Nova_forEach,
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_1_Nova_construct(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	...
	{
		nova_datastruct_list_Nova_IntArray_0_Nova_this(this, exceptionData, nova_datastruct_list_Nova_IntArray_Nova_count);
	}
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_2_Nova_construct(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int* nova_datastruct_list_Nova_IntArray_Nova_data, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	...
	{
		nova_datastruct_list_Nova_IntArray_1_Nova_this(this, exceptionData, nova_datastruct_list_Nova_IntArray_Nova_data, nova_datastruct_list_Nova_IntArray_Nova_count);
	}
...
void nova_datastruct_list_Nova_IntArray_0_Nova_this(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	nova_datastruct_list_Nova_Array_0_Nova_this((nova_datastruct_list_Nova_Array*)(this), exceptionData, nova_datastruct_list_Nova_IntArray_Nova_count);
}

void nova_datastruct_list_Nova_IntArray_1_Nova_this(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int* nova_datastruct_list_Nova_IntArray_Nova_data, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	nova_datastruct_list_Nova_Array_1_Nova_this((nova_datastruct_list_Nova_Array*)(this), exceptionData, (nova_Nova_Object**)(nova_datastruct_list_Nova_IntArray_Nova_data), nova_datastruct_list_Nova_IntArray_Nova_count);
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_IntArray_Nova_map(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_IntArray_closure3_Nova_mapFunc nova_datastruct_list_Nova_IntArray_Nova_mapFunc, void* nova_datastruct_list_Nova_IntArray_ref_Nova_mapFunc, void* mapFunc_context)
{
	...
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_datastruct_list_Nova_IntArrayIterator*)(intptr_t)(nova_datastruct_list_Nova_IntArray_Accessor_Nova_iterator((this), exceptionData));
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_Nova_take(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_howMany)
{
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_Nova_skip(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_howMany)
{
	nova_datastruct_list_Nova_IntArray* l1_Nova_list = (nova_datastruct_list_Nova_IntArray*)nova_null;
	int l2_Nova_i = 0;
...
nova_Nova_String* nova_datastruct_list_Nova_IntArray_Nova_join(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_datastruct_list_Nova_IntArray_Nova_delimiter)
{
	...
	while (nova_datastruct_list_Nova_IntArrayIterator_Accessor_Nova_hasNext(nova_local_0, exceptionData))
	{
		...
		if (l1_Nova_passed)
		{
			l1_Nova_str = (nova_Nova_String*)(nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(l1_Nova_str), exceptionData, nova_datastruct_list_Nova_IntArray_Nova_delimiter));
		}
		else
		{
			l1_Nova_passed = 1;
...
int nova_datastruct_list_Nova_IntArray_Nova_get(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_index)
{
	return (int)(intptr_t)((int*)this->nova_datastruct_list_Nova_Array_Nova_data)[nova_datastruct_list_Nova_IntArray_Nova_index];
}

int nova_datastruct_list_Nova_IntArray_Nova_set(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_index, int nova_datastruct_list_Nova_IntArray_Nova_value)
{
	((int*)this->nova_datastruct_list_Nova_Array_Nova_data)[nova_datastruct_list_Nova_IntArray_Nova_index] = nova_datastruct_list_Nova_IntArray_Nova_value;
	return nova_datastruct_list_Nova_IntArray_Nova_value;
}
