...
{
	return this->prv->nova_datastruct_list_Nova_IntArrayIterator_Nova_array->nova_datastruct_list_Nova_Array_Nova_count > this->nova_datastruct_list_Nova_IntArrayIterator_Nova_position;
}
