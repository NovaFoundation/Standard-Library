...
struct nova_datastruct_HashSet_Extension_VTable
{
	...
	nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_List_virtual_Nova_toArray)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*);
	...
	nova_Nova_String* (*nova_datastruct_list_Nova_List_virtual_Nova_join)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
	nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_List_virtual_Nova_skip)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, int);
	nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_List_virtual_Nova_take)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, int);
	nova_datastruct_list_Nova_Array* (*nova_datastruct_list_Nova_List_virtual_Nova_reverse)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*);
	...
	nova_datastruct_Nova_HashSet* (*nova_datastruct_list_Nova_List_virtual0_Nova_forEach)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_HashSet_closure18_Nova_func nova_datastruct_Nova_HashSet_Nova_func, void* nova_datastruct_Nova_HashSet_ref_Nova_func, void* func_context);
