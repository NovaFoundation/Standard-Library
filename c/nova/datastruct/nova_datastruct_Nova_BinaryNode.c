...
{
	nova_datastruct_Nova_Node_1_Nova_this((nova_datastruct_Nova_Node*)(this), exceptionData, (nova_Nova_Object*)(nova_datastruct_Nova_BinaryNode_Nova_data), nova_datastruct_Nova_BinaryNode_Nova_size);
}
