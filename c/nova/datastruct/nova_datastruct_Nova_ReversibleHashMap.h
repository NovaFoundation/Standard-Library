...
struct nova_datastruct_ReversibleHashMap_Extension_VTable
{
	...
	void (*nova_datastruct_Nova_HashMap_virtual_Nova_put)(nova_datastruct_Nova_ReversibleHashMap*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*, nova_Nova_Object*);
};
