#pragma once
#ifndef FILE_nova_c_engines_Nova_CCodeGeneratorEngine_NOVA
#define FILE_nova_c_engines_Nova_CCodeGeneratorEngine_NOVA

typedef struct nova_c_engines_Nova_CCodeGeneratorEngine nova_c_engines_Nova_CCodeGeneratorEngine;
...
typedef struct nova_c_engines_CCodeGeneratorEngine_Extension_VTable nova_c_engines_CCodeGeneratorEngine_Extension_VTable;
struct nova_c_engines_CCodeGeneratorEngine_Extension_VTable
{
	nova_Nova_Class* classInstance;
	nova_Interface_VTable itable;
	nova_Nova_String* (*nova_Nova_Object_virtual_Nova_toString)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	long_long (*nova_Nova_Object_virtual_Accessor_Nova_hashCodeLong)(nova_Nova_Object*, nova_exception_Nova_ExceptionData*);
	void (*compiler_engines_Nova_CodeGeneratorEngine_virtual_Nova_writeFiles)(nova_c_engines_Nova_CCodeGeneratorEngine*, nova_exception_Nova_ExceptionData*);
	void (*compiler_engines_Nova_CodeGeneratorEngine_virtual_Nova_insertMainMethod)(nova_c_engines_Nova_CCodeGeneratorEngine*, nova_exception_Nova_ExceptionData*);
};

extern nova_c_engines_CCodeGeneratorEngine_Extension_VTable nova_c_engines_CCodeGeneratorEngine_Extension_VTable_val;


CCLASS_CLASS
(
	nova_c_engines_Nova_CCodeGeneratorEngine, 
	
	nova_c_engines_CCodeGeneratorEngine_Extension_VTable* vtable;
