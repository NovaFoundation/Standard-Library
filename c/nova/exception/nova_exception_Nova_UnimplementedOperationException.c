...
{
	nova_exception_Nova_Exception_Nova_this((nova_exception_Nova_Exception*)(this), exceptionData, nova_exception_Nova_UnimplementedOperationException_Nova_message);
}
