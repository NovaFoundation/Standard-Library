...
{
	nova_exception_Nova_Exception_0_Nova_this((nova_exception_Nova_Exception*)(this), exceptionData, nova_Nova_String_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("File at location '")), exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_io_Nova_FileNotFoundException_Nova_file->nova_io_Nova_File_Nova_location), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("' does not exist")))));
}
