...
nova_io_Nova_File* nova_io_Nova_File_0_Nova_construct(nova_io_Nova_File* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_io_Nova_File_Nova_location)
{
	...
	{
		nova_io_Nova_File_0_Nova_this(this, exceptionData, nova_io_Nova_File_Nova_location);
	}
...
nova_io_Nova_File* nova_io_Nova_File_1_Nova_construct(nova_io_Nova_File* this, nova_exception_Nova_ExceptionData* exceptionData, FILE* nova_io_Nova_File_Nova_fp)
{
	...
	{
		nova_io_Nova_File_1_Nova_this(this, exceptionData, nova_io_Nova_File_Nova_fp);
	}
...
{
	nova_io_Nova_File_Nova_write(this, exceptionData, nova_Nova_String_virtual_Nova_concat((nova_Nova_String*)(nova_io_Nova_File_Nova_line), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n"))));
}
